import type { InsightHeroContent, RichPillarManifest } from "@mulagroup/content-models";
      ...
      <div className="grid gap-10 xl:grid-cols-[minmax(0,0.96fr)_minmax(360px,0.9fr)] xl:items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              data-cta={`${site.key}-hero-primary`}
            ...
            {site.hero.secondaryCta ? (
              <Button
                data-cta={`${site.key}-hero-secondary`}
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-3">
                  <Badge variant="neutral">{panelLabel}</Badge>
