import type { OfferFormat, SectionLead } from "@mulagroup/content-models";

import { Card, HeadingBlock, Section } from "../../components";

type PillarFormatsSectionProps = {
  formats: OfferFormat[];
  lead: SectionLead;
};

export function PillarFormatsSection({ formats, lead }: PillarFormatsSectionProps) {
  return (
    <Section>
